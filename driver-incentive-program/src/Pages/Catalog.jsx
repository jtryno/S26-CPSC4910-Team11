...
const Catalog = () => {
    ...
    const currentPriceForCartItem = (ci) => {
        ...
        if (catalogItem) {
            return Number(catalogItem.points_price);
        }
        return null;
    };
                ...
                {cartOpen && (
                    <div style={{
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <div style={{ fontSize: '12px', color: '#666' }}>
                                                ...
                                                {hasPriceIncreased(ci) && (
                                                    <div style={{ fontSize: '11px', color: '#e65100', marginTop: '2px', fontWeight: '600' }}>
                        ...
                        <div style={{ borderTop: '1px solid #e0e0e0', paddingTop: '12px', marginBottom: '12px' }}>
                            {anyPriceIncreased && (
                                <div style={{marginBottom: '10px', padding: '8px 10px', borderRadius: '4px', background: '#fff3e0', border: '1px solid #e65100', color: '#e65100', fontSize: '13px', fontWeight: '600'}}>
                                    One or more items have increased in price since being added. Your order will be placed at the original cart prices.
                                </div>
                            )}
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ borderTop: '1px solid #e0e0e0', paddingTop: '12px', marginBottom: '16px' }}>
                            {anyPriceIncreased && (
                                <div style={{ marginBottom: '10px', padding: '8px 10px', borderRadius: '4px', background: '#fff3e0', border: '1px solid #ffcc80', color: '#e65100', fontSize: '13px', fontWeight: '600' }}>
                                    One or more items have increased in price since being added. Your order will be placed at the original cart prices.
                                </div>
                            )}
                            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '15px', fontWeight: '600' }}>
